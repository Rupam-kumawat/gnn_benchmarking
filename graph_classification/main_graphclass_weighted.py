...
# --- Utility Imports ---
# MODIFIED: We only import evaluate_graphclass, as we define train locally now
...
def main():
    ...
    # --- MODIFIED: Loss Function Setup & Weight Calculation ---
    class_weights, pos_weight = None, None
    if args.use_class_weight:
        print("--- Calculating Class Weights ---")
        # Get all labels from the full dataset (before splitting)
        y_all = dataset.y
        if y_all is None: # TUDataset stores it differently sometimes or if loaded via list
    ...
    for run in range(1, args.runs + 1):
        ...
        # ... (rest of evaluation, reporting, and saving logic) ...
        report_optimal = None
        ...
        # --- MODIFIED: Changed results folder to results_weighted ---
