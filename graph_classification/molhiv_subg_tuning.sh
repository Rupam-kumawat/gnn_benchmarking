...
# ==========================================================
# Grid Search: Subgraphormer on OGBG-MOLHIV
#
# Total combinations:
...
DATASET_PARAMS="--dataset ogbg-molhiv --dataset_type ogb"
...
echo "Starting Subgraphormer grid search on MOLHIV"
...
echo "✅ Subgraphormer MOLHIV grid search complete."
